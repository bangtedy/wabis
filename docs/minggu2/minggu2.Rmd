...
if (knitr::is_html_output()) {
  meta() |> 
    meta_google_scholar(
      title = "Agribisnis: Subsistem Budidaya",
      author = "Tedy Herlambang",
...
## Pertanian dapat dipandang sebagai seni, ilmu dan bisnis menghasilkan produk pertanian, peternakan, perikanan.
...
- Tidak hanya produksi tanaman dan ternak sebagau tujuan ekonomi
